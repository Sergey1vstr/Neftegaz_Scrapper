...
def giant_function(file_path):
    ...
    #TODO: старайся избегать написания многоэтажных функций - тяжело тестировать, читать, а отделённые длинной строкой блоки просятся в отдельные более простые функции
    # то, что название функции - giant_function, хорошо говорит само за себя. Разработчику уже тяжело собраться с духом, чтобы разобраться, что она делает :)
