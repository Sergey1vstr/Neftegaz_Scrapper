...
# TODO: тут почти везде чётенько и понятно с функциями. В clean_schedule много комментов прямо в строках, содержащих код. Такого стараются избегать, но в случае с регулярными выражениями это, скорее всего, хорошая подсказка другим программистам или себе в будущем.
